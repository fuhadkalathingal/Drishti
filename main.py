...
from action_detector import BlinkDetector
...
blink_detector = BlinkDetector(closed_threshold=0.6, open_threshold=0.2)
...
while cap.isOpened():
    ...
    if result.face_blendshapes:
        ...
        blink_events = blink_detector.update(left_blink, right_blink)
